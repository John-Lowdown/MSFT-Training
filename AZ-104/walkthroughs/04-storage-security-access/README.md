...
![Storage account networking — Firewalls and virtual networks, one VNet rule and one IP rule configured](images/az104-item15-networking-firewall-vnetip-REQUIRED.png)
...
![Storage account encryption — Customer-managed keys, with a Key Vault and key selected](images/az104-item14-encryption-cmk-keyselected-REQUIRED.png)
...
![Container access policy — identifier, start/expiry, and permission checkboxes for a stored access policy](images/az104-item16-container-accesspolicy-REQUIRED.png)
