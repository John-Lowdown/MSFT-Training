...
- **This is the direct hands-on companion to Chapter 9 (governance) and Chapter 11 (monitoring)** in the book, and to Module 4 (resource locks) and Module 6 (Azure Monitor) in the video course outline — the guide explicitly names this as "Lab 7" and diagrams it in the Appendix.
